...
<div class="row category-page-row">
    ...
    ?>
		<div class="title-inner uppercase">
			<strong>Популярні товари</strong>
		</div>	
		<?php	
		echo do_shortcode( '[last_products_swiper]' ); 
		}
...
if ( is_shop() || ! empty( $category_description ) && ! is_paged() ) { ?>
<section class="section seo__block">
	<div class="section-content relative">
    <div class="row align-center">
		    <div class="col large-11 seo-text">
					<?php
					/**
				...
				<div class="col large-11 mt-15">
					<a class="button primary is-link lowercase toggleBtn arrow">
